...
namespace NoteAPI.Controllers
{
    ...
    {
        OracleConnection conn = new OracleConnection("Data Source=(LQHDB =(DESCRIPTION =(ADDRESS = (PROTOCOL = TCP)(HOST = 127.0.0.1)" +
          "(PORT = 1521))(CONNECT_DATA =(SERVER = DEDICATED)(SERVICE_NAME = lqhdb))));user id=NOTE;password=NOTE");
        int result = -1;
        //get all note
        [HttpGet("allnote")]
