...
namespace NoteApp.ViewModels
{
    ...
    {
        //private string baseUrl = "http://192.168.124.54:6002/api/TDMain";
        private string baseUrl = "http://192.168.157.54:6002/api/TDMain";
        public async Task<bool> AddTodo(TodoMain tdMain)
        {
            string json = JsonConvert.SerializeObject(tdMain);
            StringContent content = new StringContent(json, Encoding.UTF8, "application/json");
            HttpClient client = new HttpClient();
            client.BaseAddress = new Uri(baseUrl + "/addtodo");
        ...
        public async Task<bool> DeleteTask(int mainid)
        {
            ...
            client.BaseAddress = new Uri(baseUrl + "/delete/" + mainid);
        ...
        public async Task<bool> NameChange(int mainid, TodoMain tdmain)
        {
            ...
            StringContent content = new StringContent(json, Encoding.UTF8, "application/json");
            HttpClient client = new HttpClient();
            client.BaseAddress = new Uri(baseUrl + "/editTDName/" + mainid);
